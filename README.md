...
```javascript
    // event - faceDdownPiles -> Nehi aayega
...
```javascript
    // event - faceDdownPiles -> null
    
```

```javascript
    //event - drawnCard -> null

```

```javascript
    //event - handcard
    [{"suit":"Spades","value":"6"},{"suit":"Diamonds","value":"9"},{"suit":"Spades","value":"King"},{"suit":"Diamonds","value":"5"},{"suit":"Hearts","value":"5"},{"suit":"Diamonds","value":"2"},{"suit":"Diamonds","value":"3"},{"suit":"Spades","value":"10"},{"suit":"Clubs","value":"3"},{"suit":"Clubs","value":"Queen"},{ suit: 'Diamonds', value: '7' },]
```
